...
| `resources.requests`                    | The requested resources for the container                                                                                                                                                     | `{}`            |https://github.com/bitnami/charts.gitroup`            | Set Kafka pod's Security Context fsGroup                                                                                                                                                      | `1001`          |
...
| `affinity`             https://github.com/bitnami/charts.git                 | Node labels for pod assignment                                                                                                                                                                | `{}`            |
...
| `metrics.kafka.args`   https://github.com/bitnami/charts.git                                     | Override Kafka exporter container arguments                                                                                      | `[]`                                                                                    |
